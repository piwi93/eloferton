...
<div id="searchresult" class="col-xs-12">
    <?php 
        if(count($model)==0){
            ?><div style="margin-top:25%"><center><h3>Actualmente no hay ofertas en esta categoría</h3></center></div><?php
        }
        else{
            $element = 0;
            ...
            ?>
                <div class="col-sm-4">
                    <a class="col-sm-12" href = <?= Url::to(['productos/verproducto', 'id' => $oferta->id])?>>
                        <div class="row">
                        ...
                        <div class="row" >
                            <div class="well" style="width:100%;height:100%">
                                ...
                                <p>Precio: <strong>$<?=$oferta->precio?></p>
                            </div>
                        </div>
                    </a>
                </div>
