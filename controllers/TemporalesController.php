...
use app\models\TemporalesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TemporalesController implements the CRUD actions for Temporales model.
 */
class TemporalesController extends Controller
{
    ...
    /**
     * Lists all Temporales models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TemporalesSearch();
    ...
    /**
     * Displays a single Temporales model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Temporales model.
    ...
    /**
     * Deletes an existing Temporales model.
